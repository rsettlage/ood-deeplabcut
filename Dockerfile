...
RUN apt-get update && apt-get install -y librsvg libxxf86vm1 python3-wxgtk4.0 yaru-theme-icon adwaita-icon-theme-full gnome-icon-theme libatk-adaptor libcanberra-gtk-module
